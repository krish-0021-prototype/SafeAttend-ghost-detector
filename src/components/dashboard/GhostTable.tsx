...
import type { GhostStudent, Subject } from '@/lib/types';
...
export function GhostTable({ students, onNotify, notifyingId }: GhostTableProps) {
  ...
  if (students.length === 0) {
    return (
      <div className="rounded-lg border bg-white p-8 text-center">
        <p className="text-muted-foreground">No ghost students found today. Great job!</p>
      </div>
    );
  }
